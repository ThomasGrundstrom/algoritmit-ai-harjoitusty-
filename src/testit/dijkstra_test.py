...
class testDijkstra(unittest.TestCase):
    ...
    def test_tapaukset(self):
        ...
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 42272)
        kartta = self.nollaa_kartta()
        for i in range(179):
            kartta[20][i] = 3
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 1330)
        kartta = self.nollaa_kartta()
        kartta[99][179] = 0
        kartta[99][0] = 2
        for i in range(179):
        ...
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 1988)
        kartta = self.nollaa_kartta()
        for j in range(25):
            if j != 0:
                for i in range(179):
        ...
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 1378)
        kartta = self.nollaa_kartta()
        kartta[99][179] = 0
        kartta[99][0] = 2
        for j in range(25):
        ...
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 2264)
        kartta = self.nollaa_kartta()
        for j in range(25):
        ...
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 1237)
        kartta = self.nollaa_kartta()
        for j in range(50):
            for i in range(1, 179):
                kartta[j*2][i] = 3
        self.dijkstra = Dijkstra(kartta)
        self.dijkstra.reitinhaku()
        self.assertEqual(self.dijkstra.loppusolmu.etaisyys, 1384)
        kartta = self.nollaa_kartta()
        for i in range(39):
            kartta[20][i] = 3
